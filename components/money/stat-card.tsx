...
type StatCardProps = {
  ...
  value: string
  hint?: string
  /** Render the value larger — for headline figures. */
  emphasis?: boolean
}

/**
 * A small presentational stat card used across the Money module. Mirrors the
 * mortgage module's StatCard (copied, not cross-imported, per the module rule).
    ...
    <Card>
      ...
      <CardContent className="space-y-1">
        <p
          className={
            emphasis
              ? 'font-serif text-3xl font-semibold text-terracotta-700'
