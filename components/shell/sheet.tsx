...
export function Sheet({
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="relative rounded-t-[30px] rounded-b-[40px] bg-cream-100 px-[22px] pt-5 pb-8 shadow-[0_-10px_40px_rgba(0,0,0,.2)]"
        style={{ animation: 'sheetIn .28s cubic-bezier(.2,.8,.2,1)' }}
      >
        <div className="mx-auto mb-[18px] h-[5px] w-[42px] rounded-full bg-cream-400" />
